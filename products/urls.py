...
from products.views.warehouse import warehouse_list, warehouse_create, warehouse_edit, warehouse_toggle_active
from products.views.stockmove import inbound_create, outbound_create, adjust_create
from products.views.stockmove_list import stockmove_list
from products.views.item import item_list, item_create, item_update, item_toggle_active
